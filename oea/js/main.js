...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ---------- Bannière d'installation iOS/iPadOS ----------
     Safari sur iOS n'affiche jamais de bouton d'installation automatique
     (contrairement à Chrome/Android) : l'utilisateur doit passer par
     Partager > "Sur l'écran d'accueil". On l'explique ici, une seule fois. */
  (function () {
    var STORAGE_KEY = 'oea_ios_banner_dismissed';

    function isIOSDevice() {
      var ua = navigator.userAgent;
      var isIPhoneOrPod = /iPhone|iPod/.test(ua);
      var isIPad = /iPad/.test(ua) || (navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1);
      return isIPhoneOrPod || isIPad;
    }
